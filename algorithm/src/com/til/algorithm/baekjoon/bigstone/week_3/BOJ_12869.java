...
public class BOJ_12869 {
    ...
    private static List<Integer> hp = new ArrayList<>();
    ...
    public static void main(String[] args) throws IOException {
        ...
        dfs(hp.get(0), hp.get(1), hp.get(2), 0);
        bw.write(answer + "\n");
        bw.flush();
        bw.close();
        br.close();
    ...
    private static void dfs(int hp1, int hp2, int hp3, int count) {
        hp1 = Math.max(hp1, 0);
        hp2 = Math.max(hp2, 0);
        hp3 = Math.max(hp3, 0);
        ...
        dfs(hp1 - 9, hp2 - 3, hp3 - 1, count + 1);
        dfs(hp1 - 9, hp2 - 1, hp3 - 3, count + 1);
        dfs(hp1 - 3, hp2 - 9, hp3 - 1, count + 1);
        dfs(hp1 - 3, hp2 - 1, hp3 - 9, count + 1);
        dfs(hp1 - 1, hp2 - 3, hp3 - 9, count + 1);
        dfs(hp1 - 1, hp2 - 9, hp3 - 3, count + 1);
    }
}